  ...
  useEffect(() => {
    ...
    >
      <div className="flex flex-col items-center px-4">
        <h2 className="text-2xl md:text-3xl mb-6 md:mb-10 font-bold text-center">
          Sign in to your account
        </h2>
        <div className="bg-white p-6 md:p-10 rounded-lg shadow-lg w-full max-w-sm md:max-w-md lg:max-w-lg">
          <form onSubmit={handleLogin}>
            ...
            <button
              ...
              className="w-full py-2 px-4 text-sm text-white rounded-md hover:bg-blue-600 transition duration-200"
            >
              {isSubmitting ? (
